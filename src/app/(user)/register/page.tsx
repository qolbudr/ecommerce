                ...
                <div className="flex items-center justify-center h-full px-6 lg:px-16">
                    <div className="w-full max-w-md ">
                        ...
                        <form className="space-y-3 mt-8">
                            <Input filled={false} label="Email" type="text" placeholder="Contoh: user@gmail.com"/>
                            <Input filled={false} label="Nomor Telepon" type="text" placeholder="Contoh: 08123456789"/>
                            <Input filled={false} label="Password" type="password" placeholder="Masukkan password"/>
                            <Button fullWidth className="mt-8" type="submit">Daftar</Button>
                        </form>
                    </div>
