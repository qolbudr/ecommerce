...
export const Modal = (props: ModalProps) => {
  ...
  return (
    <div
      ...
      <div
        className={`bg-white shadow-lg w-full max-w-lg relative transform transition-all duration-200
        ...
        <hr className="border-t border-neutral-40" />
        <div className="w-full flex justify-end items-center space-x-3 p-6">
          {
            props.cta && (
